...
contract Ambix is Ownable {
    /* Recipe fields */
    StandardBurnableToken[][] public rSource;
    uint[][]                  public rSourceCoef;
    StandardBurnableToken[]   public rSink;
    ...
    function run() public {
        ...
        for (i = 0; i < rSource.length; ++i) {
            ...
            for (j = 0; j < rSource[i].length; ++j) {
                ...
                if (value <= token.allowance(msg.sender, this)) {
