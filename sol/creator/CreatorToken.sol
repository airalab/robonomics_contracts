...
library CreatorToken {
    ...
    function create(string _name, string _symbol, uint8 _decimals, uint256 _count) returns (Token) {
        var inst = new Token(_name, _symbol, _decimals, _count);
